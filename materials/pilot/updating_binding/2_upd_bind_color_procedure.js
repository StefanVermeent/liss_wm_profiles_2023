...
var binding_updating_color_empty = {
  type: jsPsychBindingUpdatingColorGrid,
  stimulus: "",
  pos: 0,
  nBind: function(){return jsPsych.timelineVariable("nBind")},
...
var binding_updating_color_recall = {
...
var binding_updating_color_stim_loop = {
  timeline: [binding_updating_color, binding_updating_color_empty],
...
var binding_updating_color_recall_loop = {
  timeline: [binding_updating_color_recall],
  loop_function: function(){
...
var binding_updating_color_full_loop = {
  timeline: [fixation, binding_updating_color_stim_loop, binding_updating_color_recall_loop].flat(2),
  timeline_variables: [
    generate_bind_upd_timeline(nBind = 3, nUpd = 0, stimset = color_set),
    generate_bind_upd_timeline(nBind = 3, nUpd = 2, stimset = color_set),
  ]
}
