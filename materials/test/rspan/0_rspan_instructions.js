  ...
  timeline: [
    {
      ...
      pages: [
        ...
        "<p style = 'text-align: center;'>"+
          ...
          "<img width = 250 src = img/instr01.png></img><br><br>",
        ...
        //page 5
          ...
          '<img width = 250 src = img/instr02.png></img><br><br>',
  ...
  timeline: [
    {
      ...
      pages: [
        ...
        "<p style = 'text-align: center;'>"+
          ...
          "<div style = 'float: left;'>Als de letter <strong><span style = 'color: green;'>NORMAAL</span></strong> is,<br>druk dan op de '<strong>A</strong>' toets<br>op uw toetsenbord.<br>" + "<img src=" + '"img/f_0_normal.png">' + "</div>" +
          "<div style = 'float: right;'>Als de letter <strong><span style = 'color: red;'>GESPIEGELD</span></strong> is,<br>druk dan op de '<strong>L</strong>' toets<br>op uw toetsenbord.<br>" + "<img src=" + '"img/f_0_mirror.png">' + "</div><br><br><br>",
        ...
        //page 5
         ...
         "<div style = 'float: left;'><strong><span style = 'color: green;'>NORMAAL</span></strong><br><img src=" + '"img/r_315_normal.png">' + "</div>" +
         "<div style = 'float: right;'><strong><span style = 'color: red;'>GESPIEGELD</span></strong><br><img src=" + '"img/r_225_mirror.png">' + "</div><br><br><br><br>",

         //page 6
         "<p style = 'text-align: center;'>" +
         "U moet de letter soms dus eerst in uw hoofd omdraaien voordat u kunt bepalen of hij gespiegeld is.<br>" +
         "<div style = 'float: left;'><strong><span style = 'color: green;'>NORMAAL</span></strong><br><img src=" + '"img/f_180_normal.png">' + "</div>" +
         "<div style = 'float: right;'><strong><span style = 'color: red;'>GESPIEGELD</span></strong><br><img src=" + '"img/r_270_mirror.png">' + "</div><br><br><br><br>",
  ...
  timeline: [
    {
      ...
      pages: [
        ...
        "<p style = 'text-align: center;'>"+
          ...
          "<img width = 400 src = img/instr03.png></img><br><br>",
